...
using RE = Compiler.Scanner.Regular.RegularExpression;
using Compiler.Scanner.Common;
using Compiler.Scanner.Lex;
using Compiler.Scanner.DFA;
using Compiler.Scanner.NFA;
using Compiler.Scanner.Scan;

namespace Compiler.Scanner.Test
{
    [TestFixture]
    public class ScannersTest
    {
        ...
        public void CompactCharSetTest()
        {
            ...
            Compiler.Scanner.Scan.Scanner s = new Compiler.Scanner.Scan.Scanner(scannerInfo);
        ...
        [Test]
        public void ThrowNoExceptionAtEosTest()
        {
            Lexicon lexicon = new Lexicon();
            Lexer global = lexicon.Lexer;
            ...
            Assert.AreEqual(info.EndOfStreamTokenIndex, leof2.TokenIndex);
            Assert.AreEqual(leof2.Span.StartLocation.CharIndex, leof2.Span.EndLocation.CharIndex);
            Assert.AreEqual(source.Length, leof2.Span.StartLocation.CharIndex);
